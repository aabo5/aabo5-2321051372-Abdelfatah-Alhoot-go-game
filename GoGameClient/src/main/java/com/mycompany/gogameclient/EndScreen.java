...
public class EndScreen extends javax.swing.JFrame {
    ...
    private class EndScreenListener implements NetworkClient.ServerMessageListener {
        ...
        public void onOpponentDisconnected() {
            javax.swing.SwingUtilities.invokeLater(() -> {
                javax.swing.JOptionPane.showMessageDialog(EndScreen.this,
                        "Your opponent has disconnected.",
                        "Opponent Left", javax.swing.JOptionPane.WARNING_MESSAGE);
                jButton_PlayAgain.setEnabled(false);
                jButton_PlayAgain.setText("OPPONENT LEFT");
            });
        }
        ...
        jPanel2Layout.setVerticalGroup(
                jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(jPanel2Layout.createSequentialGroup()
                                .addGap(118, 118, 118)
                                .addComponent(jPanel1, javax.swing.GroupLayout.PREFERRED_SIZE, 273,
                                        javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void jButton_PlayAgainActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_jButton_PlayAgainActionPerformed
        ...
        if (networkClient != null) {
            ...
            jButton_PlayAgain.setEnabled(false);
            jButton_PlayAgain.setText("WAITING...");
