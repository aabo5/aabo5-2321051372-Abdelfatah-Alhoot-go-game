...
public class StartScreen extends javax.swing.JFrame {
    ...
    private void jButton_StartActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_jButton_StartActionPerformed
        ...
        new Thread(() -> {
            try {
                ...
                networkClient.setListener(new LobbyListener());
            } catch (java.io.IOException ex) {
                javax.swing.SwingUtilities.invokeLater(() -> {
                    javax.swing.JOptionPane.showMessageDialog(this,
                            "Could not connect to server at " + ip + ":5000\n" + ex.getMessage(),
    ...
    private class LobbyListener implements NetworkClient.ServerMessageListener {
        ...
        public void onWelcome(String color) {
            myColor = color;
            javax.swing.SwingUtilities.invokeLater(() -> jButton_Start.setText("You are " + color + " — waiting..."));
        }
        ...
        public void onOpponentDisconnected() {
            javax.swing.SwingUtilities.invokeLater(() -> {
                javax.swing.JOptionPane.showMessageDialog(StartScreen.this,
                        "Server connection lost.", "Disconnected",
        ...
        public void onMessage(String text) {
            javax.swing.SwingUtilities.invokeLater(() -> jButton_Start.setText(text));
        }
    }
